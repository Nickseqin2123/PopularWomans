...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='women',
            name='is_published',
            field=models.BooleanField(choices=[(False, 'Черновик'), (True, 'Опубликовано')], default=0, verbose_name='Опубликована'),
        ),
        migrations.AlterField(
            model_name='women',
            name='slug',
            field=models.SlugField(max_length=255, unique=True, validators=[django.core.validators.MaxLengthValidator(100, message='Слишком длинный URL. Максимум 100 символов'), django.core.validators.MinLengthValidator(5, message='Слишком короткий URL. Минимум 5 символов')], verbose_name='Slug'),
        ),
        migrations.AlterField(
            model_name='women',
            name='tags',
        ...
        migrations.AlterField(
            model_name='women',
            name='time_update',
            field=models.DateTimeField(auto_now=True, verbose_name='Время обновления статьи'),
        ),
        migrations.AlterField(
            model_name='women',
            name='title',
