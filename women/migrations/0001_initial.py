# Generated by Django 4.2.13 on 2024-06-03 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, validators=[django.core.validators.MaxLengthValidator(100, message='Слишком длинный URL. Максимум 100 символов'), django.core.validators.MinLengthValidator(5, message='Слишком короткий URL. Минимум 5 символов')], verbose_name='Slug')),
                ...
                ('is_published', models.BooleanField(choices=[(False, 'Черновик'), (True, 'Опубликовано')], default=0, verbose_name='Опубликована')),
